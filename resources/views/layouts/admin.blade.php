...
<body class="app header-fixed sidebar-fixed aside-menu-fixed pace-done sidebar-lg-show">
    <header class="app-header navbar">
        ...
        <ul class="nav navbar-nav ml-auto pr-5">
            ...
            @endif
            <li class="nav-item dropdown d-md-down-none mr-4">
                <a class="nav-link" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                    {!! "Change Sites: <b>".strtoupper(config('panel.sites.current'))."</b>" !!}
                </a>
                <div class="dropdown-menu dropdown-menu-right">
            ...
            <li class="nav-item dropdown d-md-down-none">
                <a class="nav-link" href="{{ config("app.url") }}" target="_blank">
                    View Site: <b class="text-primary">{{ strtoupper(config('panel.sites.current')) }}</b>
                </a>
            </li>
        </ul>
    </header>
    ...
    <script src="https://www.slottomat.com/asset/admin/js/ckeditor.js"></script>
    <script>
        $(function() {
